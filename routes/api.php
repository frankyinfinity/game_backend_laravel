...
Route::group(['prefix' => 'auth'], function () {
  ...
  Route::post('/game/calculate_score', [App\Http\Controllers\Api\GameController::class, 'calculateScore'])->name('game.calculate_score');
  Route::post('/game/player/recreate_all_containers', [App\Http\Controllers\Api\GameController::class, 'recreateAllPlayerContainers'])->name('game.player.recreate_all_containers');
  ...
  Route::post('/game/evolution/save', [App\Http\Controllers\Api\GameController::class, 'evolutionSave'])->name('game.evolution.save');
