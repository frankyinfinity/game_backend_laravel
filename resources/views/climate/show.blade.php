...
<div class="card">
    <div class="card-header pb-0">
        <h4 class="mb-0">Modifica Clima</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('climates.update', [$climate->id]) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="name" name="name" value="{{$climate->name}}" class="form-control" placeholder="Nome" required>
                    </div>
                </div>
                <div class="col-6">
                    <label class="mb-0 text-white">...</label><br>
                    <div class="form-check form_check_with_checkbox">
                        <input class="form-check-input" type="checkbox" name="started" @if($climate->started) checked @endif>
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" id="min_temperature" name="min_temperature" value="{{$climate->min_temperature}}" class="form-control" placeholder="Temperatura MIN" required>
                    </div>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" id="max_temperature" name="max_temperature" value="{{$climate->max_temperature}}" class="form-control" placeholder="Temperatura MAX" required>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select id="default_tile_id" name="default_tile_id" class="form-control" required>
                          @foreach ($tiles as $tile)
                            <option value="{{$tile->id}}" @if($climate->default_tile_id === $tile->id) selected @endif>{{$tile->name}}</option>
                          @endforeach
                        </select>
                    </div>
                </div>
