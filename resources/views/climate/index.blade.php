        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="row">
                    <div class="col-6"></div>
                    <div class="col-3">
                        <button type="button" class="btn btn-danger btn-block btn-sm js-delete" data-list="table_list" data-url="{{ route('climates.delete') }}">
                            <i class="fa fa-trash"></i> Cancella
                        </button>
                    </div>
                    <div class="col-3">
                        <a href="{{route('climates.create')}}">
    ...
    <script> 
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn_edit', function (e) {
                var url="{{ route('climates.show',['_id_']) }}";
            ...
            var table = $("#table_list").DataTable({
                ...
                columns: [
                    ...
                    {data:"min_temperature", name:"min_temperature"},
                    {data:"max_temperature", name:"max_temperature"},
                    {data:"default_tile.name", name:"default_tile.name"},
                    {data:"id", name:"id"},
                ],
