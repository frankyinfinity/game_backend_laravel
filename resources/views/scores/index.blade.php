        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="row">
                    <div class="col-6"></div>
                    <div class="col-3">
                        <button type="button" class="btn btn-danger btn-block btn-sm js-delete" data-list="table_list" data-url="{{ route('scores.delete') }}">
    ...
    <script> 
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn_edit', function (e) {
                var url="{{ route('scores.edit',['_id_']) }}";
