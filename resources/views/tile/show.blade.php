...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('tiles.update', [$tile->id]) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="input-group my-colorpicker colorpicker-element" data-colorpicker-id="2">
                          <input type="text" id="color" name="color" class="form-control" value="{{$tile->color}}" data-original-title="" title="">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select id="type" name="type" class="form-control" required>
                          <option value="{{ App\Models\Tile::TYPE_SOLID }}" @if($tile->type === App\Models\Tile::TYPE_SOLID) selected @endif>Solido</option>
                          <option value="{{ App\Models\Tile::TYPE_LIQUID }}" @if($tile->type === App\Models\Tile::TYPE_LIQUID) selected @endif>Liquido</option>
                        </select>
                    </div>
                </div>
                <div class="col-12">
