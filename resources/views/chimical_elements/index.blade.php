...
@section('title', 'Elementi Chimici')
...
<div class="card">
    <div class="card-header pb-0">
        <h4 class="mb-0">Elementi Chimici</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="row">
                    <div class="col-6"></div>
                    <div class="col-3">
                        <button type="button" class="btn btn-danger btn-block btn-sm js-delete" data-list="table_list" data-url="{{ route('chimical-elements.delete') }}">
                            <i class="fa fa-trash"></i> Cancella
                        </button>
                    </div>
                    <div class="col-3">
                        <a href="{{route('chimical-elements.create')}}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.btn_edit', function (e) {
                var url="{{ route('chimical-elements.edit',['_id_']) }}";
            ...
            var table = $("#table_list").DataTable({
                ...
                ajax: {
                    type: 'POST',
                    url: '{{ route('chimical-elements.datatable') }}',
                    headers: {
