                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 150px;">
                                        Diffusione (0-100%)
                                        <i class="fas fa-info-circle text-muted ml-1" title="Percentuale in cui l'elemento può apparire in quel tile" data-toggle="tooltip" style="cursor: help;"></i>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <div style="display:flex; align-items:center;">
                                                @if(\Storage::disk('tile')->exists($tile->id . '.png'))
                                                <img src="{{ asset('storage/tiles/' . $tile->id . '.png') }}?v={{ time() }}" style="width:24px;height:24px;image-rendering:pixelated;margin-right:10px;border:1px solid #ddd;border-radius:3px;">
                                                @else
